...
CINEMATIC_BASE = (
    ...
    "写实摄影质感，8K超高清，2.35:1 超宽幅电影构图（横版宽屏），主体居中，左右两侧留出延伸空间"
)
...
5. 不要有文字或文案在画面里
6. **控制在 120-180 字**
7. ⚠️ **画面是 2.35:1 超宽幅横版**（电影宽银幕比例）：
   - 主体居中，左右两侧要描述有"延伸空间"——比如远景的城市天际线、向两侧扩散的光线、横向延展的数据流等
   - 不要把核心元素画得满满当当撑满画面
   - 多用"广阔的""横向延展的""左右两侧"这样的方位词，引导画面往横向构图发展
